...
public class UserDaoImpl implements UserDao {
    ...
    @Override
    public long insertTransaction(User user) throws SQLException {
        String sql = "INSERT INTO " + buildTable() + "(id, username, phone, created_date) VALUES(?,?,?,now())";
        return Db.updateTransaction(sql, new Object[]{user.getId(), user.getUsername(), user.getPhone()}, ShardingContext.CENTER);
    }
